 ...
 * @time    10/03/2025 15:08:07
 * @package src/app/_partials/ProjectCard.tsx
 */
...
const ProjectCardComponent: React.FC<ProjectCardProps> = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  return (
    <Fragment>
      <div
